    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-24 left-20 opacity-8">
          <svg width="120" height="60" viewBox="0 0 120 60" fill="none" stroke="#C084FC" strokeWidth="0.4">
        ...
        <div className="absolute top-72 right-28 opacity-7">
          <svg width="140" height="52" viewBox="0 0 140 52" fill="none" stroke="#A855F7" strokeWidth="0.3">
        ...
        <div className="absolute bottom-40 left-16 opacity-9">
          <svg width="105" height="42" viewBox="0 0 105 42" fill="none" stroke="#C084FC" strokeWidth="0.4">
        ...
        <div className="absolute top-48 left-28 opacity-6">
          <svg width="180" height="22" viewBox="0 0 180 22" fill="none" stroke="#C084FC" strokeWidth="0.5">
            ...
            <circle cx="32" cy="8.5" r="0.8" fill="#C084FC" opacity="0.3" />
            <circle cx="88" cy="13.5" r="0.8" fill="#C084FC" opacity="0.3" />
            <circle cx="144" cy="9.5" r="0.8" fill="#C084FC" opacity="0.3" />
          </svg>
        </div>

        <div className="absolute bottom-56 right-20 opacity-7">
          <svg width="160" height="26" viewBox="0 0 160 26" fill="none" stroke="#A855F7" strokeWidth="0.4">
            ...
            <circle cx="46" cy="11" r="0.7" fill="#A855F7" opacity="0.4" />
            <circle cx="104" cy="15" r="0.7" fill="#A855F7" opacity="0.4" />
          </svg>
        </div>

        <Heart
          className="absolute top-1/5 left-1/8 w-4 h-4 animate-bounce opacity-14"
          style={{ color: "#C084FC", animationDelay: "0.3s", animationDuration: "4s" }}
        />
        <Heart
          className="absolute top-2/3 right-1/6 w-3 h-3 animate-bounce opacity-17"
          style={{ color: "#A855F7", animationDelay: "2s", animationDuration: "3.5s" }}
        />
        <Heart
          className="absolute bottom-1/4 right-3/4 w-5 h-5 animate-bounce opacity-15"
          style={{ color: "#C084FC", animationDelay: "1.2s", animationDuration: "3.8s" }}
        />

        <Star
          className="absolute top-1/8 right-1/4 w-3 h-3 animate-pulse opacity-20"
          style={{ color: "#A855F7", animationDelay: "0.8s", animationDuration: "2.8s" }}
        />
        <Star
          className="absolute bottom-1/3 left-1/5 w-4 h-4 animate-pulse opacity-16"
          style={{ color: "#C084FC", animationDelay: "2.5s", animationDuration: "3.2s" }}
        />
        <Star
          className="absolute top-3/4 left-2/3 w-3 h-3 animate-pulse opacity-18"
          style={{ color: "#A855F7", animationDelay: "1.7s", animationDuration: "2.5s" }}
        />
      </div>
        ...
        <div className="relative">
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 20px rgba(192, 132, 252, 0.35), 0 4px 16px rgba(126, 34, 206, 0.4)",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl mb-8">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "inset 0 0 25px rgba(192, 132, 252, 0.12), 0 12px 40px rgba(126, 34, 206, 0.08)",
          ...
          <div
            ...
            style={{
              backgroundColor: "rgba(28, 31, 46, 0.3)",
              boxShadow: "inset 0 0 25px rgba(168, 85, 247, 0.12), 0 12px 40px rgba(126, 34, 206, 0.08)",
